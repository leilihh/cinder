...
class BackupManager(manager.SchedulerDependentManager):
    ...
    def create_backup(self, context, backup_id, is_online):
        ...
        LOG.info(_LI('###########ONLINE: is_online = %d'), is_online)
        ...
        try:
            ...
            if is_online:
                LOG.info(_("############# LEILI: will enter online mode"))
                self._get_driver(backend).backup_volume_online(context, backup,
                                                               backup_service)
            else:
                LOG.info(_("############# LEILI: will enter offline mode"))
